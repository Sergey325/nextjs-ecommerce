    ...
    return (
        <button
            ...
            className={`
                ...
                ${outline ? "hover:shadow-[0_0_0_3px_rgba(100,116,139,1)]" : gradient ? "hover:drop-shadow-[0_2px_6px_rgba(137,63,237,0.90)]" : "hover:drop-shadow-[0_5px_8px_rgba(98,143,200,0.90)]"}
