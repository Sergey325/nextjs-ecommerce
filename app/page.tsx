    ...
    return (
        <Container>
            <section className="pt-12 flex flex-col-reverse md:flex-row items-center gap-4">
                ...
                <div className=" text-gray-400 flex flex-col gap-4 md:gap-8 md:w-1/2">
                    <span className="text-4xl lg:text-5xl xl:text-6xl 2xl:text-6xl text-gray-300">Bring Your Dreams to Life: <br/>Build the Perfect PC</span>
